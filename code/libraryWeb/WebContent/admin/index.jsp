...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;">
          <img src="../public/image/cat.png" class="layui-nav-img">
          系统管理员
        </a>
        <dl class="layui-nav-child">
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        ...
        <li class="layui-nav-item"><a href="./librarydata.jsp" target="content"><i class="layui-icon layui-icon-windows" style="font-size: 16px; color: #1E9FFF;"> </i>系统借书情况</a></li>
        <li class="layui-nav-item"><a href="./drup.jsp" target="content"><i class="layui-icon layui-icon-windows" style="font-size: 16px; color: #1E9FFF;"> </i>数据备份与恢复</a></li>
      </ul>
    </div>
  </div>
