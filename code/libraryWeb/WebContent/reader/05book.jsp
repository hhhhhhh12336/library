...
<body>
	...
	<script type="text/html" id="headBar">
		...
		<div class="layui-inline">
			...
			<option value="position">图书位置</option>
			<option value="description">图书描述</option>
		  </select>
	 	 </div>
  		<div class="layui-inline">
	...
	layui.use(['table','jquery'], function(){
	  ...
	  var tableIns =  table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'author', width:100, title: '图书作者', sort: true}
	      ,{field:'library_id', title: '图书馆', width: 100, sort: true}
	      ,{field:'sort_id', width:100, title: '图书分类', sort: true,}
	      ,{field:'position', width:100, title: '图书位置', sort: true}
	      ,{field:'status', width:100, title: '借阅状态', sort: true,templet: function (item) {
	    	  var btns="";
	    	  if(item.status=='0'){
	      ...
	      ,{field:'description', minWidth:80, title: '图书描述'}
