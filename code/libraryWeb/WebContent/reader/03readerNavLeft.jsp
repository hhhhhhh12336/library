...
<body>
	...
	<div style="text-align:center;width:100%;height:100%;font-size：30px;">
		<ul class="nav nav-pills nav-stacked nav-inverse sidebar faq-tabbable">
		<% if(session.getAttribute("reader")!=null){%>				  
			<li role="presentation"><a href="01main.jsp" target="view_frame"><span class="glyphicon glyphicon-picture" aria-hidden="true">&nbsp;系统首页</span></a></li>
			...
			<li role="presentation"><a href="07announcement.jsp" target="view_frame"><span class="glyphicon glyphicon-bullhorn" aria-hidden="true">&nbsp;系统公告</span></a></li>
