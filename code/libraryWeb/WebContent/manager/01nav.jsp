  ...
  <div class="layui-header">
   ...
   <ul class="layui-nav layui-layout-left">
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item">
        <a href="javascript:;">
        <img src="../public/image/cat1.png" class="layui-nav-img">
      ...
      <li class="layui-nav-item"><a href="./quit" target="_parent">退出系统</a></li>
    </ul>
  </div>
    ...
    <div class="layui-side-scroll">
      ...
      <ul class="layui-nav layui-nav-tree"  lay-filter="test">
        <li class="layui-nav-item layui-nav-itemed">
          <a class="" href="javascript:;"><i class="layui-icon layui-icon-read" style="font-size: 20px; color: lightblue;"></i>&nbsp;借还图书</a>
          <dl class="layui-nav-child">
        ...
        <li class="layui-nav-item">
          <a href="javascript:;"><i class="layui-icon layui-icon-form" style="font-size: 20px; color: orange;"></i>&nbsp;借还记录</a>
          <dl class="layui-nav-child">
            <dd><a href="06borrowTable.jsp" target="content">还书记录</a></dd>
            <dd><a href="07returnTable.jsp" target="content">借书记录</a></dd>
          </dl>
        </li>
